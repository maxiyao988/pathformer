...
from pathformer.layers.Layer import Transformer_Layer
from pathformer.utils.Other import SparseDispatcher, FourierLayer, series_decomp_multi, MLP
...
class AMS(nn.Module):
    ...
    def forward(self, x, loss_coef=1e-2):
        ...
        # Expose the per-sample router gate weights (non-persistent, plain
        # attribute) so downstream experiment scripts can log/inspect scale
        # selection without changing this method's return signature.
