...
from pathformer.layers.Layer import WeightGenerator, CustomLinear
...
class Model(nn.Module):
    def __init__(self, configs):
        ...
        # Dual-attention ablation switches (Experiment A6). getattr keeps this
        # backward compatible with any config object that doesn't define them.
        use_intra = getattr(configs, "use_intra", True)
        use_inter = getattr(configs, "use_inter", True)
